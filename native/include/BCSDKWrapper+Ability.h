...
int _BCSDK_ BCSDK_GetSupportRecordEnable(H_BC_DEVICE hDevice, bool *support);
...
int _BCSDK_ BCSDK_GetSupportDeleteRecordFiles(H_BC_DEVICE hDevice, bool *support);
...
int _BCSDK_ BCSDK_GetSupportEmailEnable(H_BC_DEVICE hDevice, bool *support);
int _BCSDK_ BCSDK_GetSupportPushTask(H_BC_DEVICE hDevice, bool *support);
int _BCSDK_ BCSDK_GetSupportPushEnable(H_BC_DEVICE hDevice, bool *support);
...
int _BCSDK_ BCSDK_GetQRAudios(H_BC_DEVICE hDevice, BC_QR_AUDIOS_INFO *info);
int _BCSDK_ BCSDK_GetSupportSamba(H_BC_DEVICE hDevice, int channel, bool *support);
// scheduleVersion, bit0:support output schedule and timing is a bit of trigger type.
int _BCSDK_ BCSDK_GetScheduleVersion(H_BC_DEVICE hDevice, int *version);
// buzzer
int _BCSDK_ BCSDK_GetSupportBuzzer(H_BC_DEVICE hDevice, bool *support);
int _BCSDK_ BCSDK_GetSupportBuzzerTask(H_BC_DEVICE hDevice, bool *support);
int _BCSDK_ BCSDK_GetSupportBuzzerEnable(H_BC_DEVICE hDevice, bool *support);
// channel version
int _BCSDK_ BCSDK_GetSupportChannelVersion(H_BC_DEVICE hDevice, bool *support);
...
int _BCSDK_ BCSDK_GetSupportAIPeople(H_BC_DEVICE hDevice, int channel, bool *support);
...
int _BCSDK_ BCSDK_GetSupportTimelapseThumbnail(H_BC_DEVICE hDevice, int channel, bool *support);
