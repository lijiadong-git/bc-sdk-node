...
/* config for ipc upload files to base
 *
 * callback with E_BC_CMD_GET_NAS_CFG, E_BC_CMD_SET_NAS_CFG
 */
int _BCSDK_ BCSDK_RemoteGetNasCfg(H_BC_DEVICE hDevice);
int _BCSDK_ BCSDK_RemoteSetNasCfg(H_BC_DEVICE hDevice, BC_NAS_CFG *cfg);


/* Samba
 *
 * callback with E_BC_CMD_GET_SMB_CFG, E_BC_CMD_SET_SMB_CFG,
 */
int _BCSDK_ BCSDK_RemoteGetSambaCfg(H_BC_DEVICE hDevice);
int _BCSDK_ BCSDK_RemoteSetSambaCfg(H_BC_DEVICE hDevice, BC_SMB_CFG *cfg);
 ...
 */
int _BCSDK_ BCSDK_DeleteRecFiles(H_BC_DEVICE hDevice, BC_DEL_REC_FILES *files);
 ...
 */
int _BCSDK_ BCSDK_RemoteGetRecordEnable(H_BC_DEVICE hDevice);
int _BCSDK_ BCSDK_RemoteSetRecordEnable(H_BC_DEVICE hDevice, BC_ALARM_OUT_ENABLE_CFG *enable);

/* Ftp enable
 *
 * callback with E_BC_CMD_GET_FTP_ENABLE, E_BC_CMD_SET_FTP_ENABLE
 */
int _BCSDK_ BCSDK_RemoteGetFtpEnable(H_BC_DEVICE hDevice);
int _BCSDK_ BCSDK_RemoteSetFtpEnable(H_BC_DEVICE hDevice, BC_ALARM_OUT_ENABLE_CFG *enable);
 ...
 */
int _BCSDK_ BCSDK_RemoteGetEmailEnable(H_BC_DEVICE hDevice);
int _BCSDK_ BCSDK_RemoteSetEmailEnable(H_BC_DEVICE hDevice, BC_ALARM_OUT_ENABLE_CFG *enable);
 ...
 */
int _BCSDK_ BCSDK_RemoteGetPushEnable(H_BC_DEVICE hDevice);
int _BCSDK_ BCSDK_RemoteSetPushEnable(H_BC_DEVICE hDevice, BC_ALARM_OUT_ENABLE_CFG *enable);
 ...
 */
int _BCSDK_ BCSDK_RemoteGetBuzzerEnable(H_BC_DEVICE hDevice);
 ...
 */
int _BCSDK_ BCSDK_RemoteGetAiCfg(H_BC_DEVICE hDevice, int channel);
int _BCSDK_ BCSDK_RemoteSetAiCfg(H_BC_DEVICE hDevice, int channel, BC_AI_CFG *aiCfg, int cmdIdx);
 ...
 */
int _BCSDK_ BCSDK_RemoteGetBuzzerTask(H_BC_DEVICE hDevice, int channel);
int _BCSDK_ BCSDK_RemoteSetBuzzerTask(H_BC_DEVICE hDevice, int channel, BC_BUZZER_TASK *buzzerTask);
